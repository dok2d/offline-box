...
Автономный домашний сервер на базе Debian с 12 сервисами, работающими в rootless Podman контейнерах за nginx reverse proxy. Предназначен для работы в условиях ограниченного или полностью отсутствующего интернет-соединения.
